...
*Формы червоточин в зависимости от темпа закачки кислоты в породу*
...
*Учет результатов фильтрационных исследований в симуляторе СКО ![](./images/image-2.png) RockStim*
